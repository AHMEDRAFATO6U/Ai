...
data = pickle.load(open('D:\Diabtes AI Project\Diabetes.sav', 'rb'))
        ...
        try:
            ...
            with st.sidebar:
                if result[0] == 0:
                    ...
                    st.image("D:\Diabtes AI Project\Screenshot 2024-10-22 231216.png", width=300)
                else:
                    st.error('The Patient Has Diabetes')
                    st.image("D:\Diabtes AI Project\Screenshot 2024-10-24 130623.png", width=300)
